...
$(document).ready(function(){
	...
	$('#s').click(function(){
		$('#parallax').css('background-image', 'url(imgs/maglith.JPG)');
	...
	$('#p').click(function(){
		$('#parallax').css('background-image', 'url(imgs/political.JPG)');
	...
	$('#r').click(function(){
		$('#parallax').css('background-image', 'url(imgs/religious.JPG)');
